...
- [src/syntaxes/floorplans.monarch.ts](src/syntaxes/floorplans.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/floorplans.tmLanguage.json](syntaxes/floorplans.tmLanguage.json) - Textmate based syntax highlighting instructions.
